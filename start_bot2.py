#!/usr/bin/env python3
"""
Скрипт для запуска второго бота Pachka (универсальный)
"""
...
def print_help():
    """Выводит справку"""
    print("=" * 70)
    print("🤖 MRNet Bot SIMs - Запуск второго бота (универсальный)")
    print("=" * 70)
    print()
    print("Использование:")
    print("  python start_bot2.py         # Запуск второго бота (bot2)")
    print("  python start_bot2.py bot1    # Запуск первого бота из конфига")
    print("  python start_bot2.py bot2    # Запуск второго бота из конфига")
    print("  python start_bot2.py --check  # Проверка конфигурации")
    print("  python start_bot2.py --help   # Показать эту справку")
    print()
...
def main():
    ...
    print("🤖 Запуск второго бота Pachka (универсальный)...")
    print()
    ...
    if errors:
        ...
        print("   Для справки: python start_bot2.py --help")
        sys.exit(1)
    ...
    try:
        ...
        # Устанавливаем аргумент командной строки для второго бота (если не указан)
        if len(sys.argv) == 1:
